          ...
          <div className="flex gap-10 justify-center">
            <div className="w-2/3 ">
              <div className="w-full flex pl-3 pr-3">
                ...
                <div className="flex text-xs font-bold mt-10 pl-6 pr-6 w-full justify-between">
            ...
            <div className="flex w-1/4 items-center mt-16 border rounded flex-col">
              <h1 className="mt-2">RESUMEN DE COMPRA</h1>
              <div className="flex flex-col w-full items-center">
                <h1 className="w-64 ">Subtotal</h1>
                <span className="w-64 h-px bg-gray-200"></span>
